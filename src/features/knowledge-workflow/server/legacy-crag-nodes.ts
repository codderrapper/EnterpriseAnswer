// Legacy CRAG node implementations — re-exported from here so that
// src/lib/crag/nodes.ts can be a pure shim. Do not add new logic here.

import type { RunnableConfig } from "@langchain/core/runnables";
import type { SupabaseClient } from "@supabase/supabase-js";
import type { CragState, GradedChunk, Decision, SendFn, NodeOutputSummary } from "./legacy-crag-types";
