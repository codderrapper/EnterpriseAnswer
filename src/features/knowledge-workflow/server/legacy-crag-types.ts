// Legacy CRAG protocol types — kept for backward compatibility with
// src/lib/crag shims and consumers such as agentStore, NodeDetailPanel, AgentGraph.
// Do not add new types here; use types.ts for new workflow types.
